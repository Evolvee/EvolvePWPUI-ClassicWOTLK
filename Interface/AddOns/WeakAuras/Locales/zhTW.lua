...
L["GetNameAndIcon Function (fallback state)"] = "GetNameAndIcon 函數(回退狀態）"
L["Glancing"] = "偏斜"
...
|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = "WeakAuras檢測到它已被降級。您保存的光環可能不再正常工作。您想運行|cffff0000試驗性|r 修復工具嗎？這將覆蓋自上次數據庫升級以來所做的任何更改。最後更新：%s |cffff0000在按此按鈕之前，您應該備份您的WTF資料夾。|r"
