...
-- retail's config is commented out until i have time to fix it.
...
--     local dropIcon = AMConfig:CreateTexture(nil, "MEDIUM", nil, 2);
...
--                 ArenaMarkerDB[cli    ckIDString] = self:GetID();
