...
AUCTIONATOR_RECENT_SEARCHES = {
	...
	"spellthre", -- [3]
	"shadow power", -- [4]
	"spirit;Consumable/Item Enhancement;;;;;;;;;", -- [5]
	";Consumable/Item Enhancement;;;;;;;;;", -- [6]
	"Netherweave Cloth", -- [7]
	"netherwe", -- [8]
	"Handful of Fel Iron Bolts", -- [9]
	"Fel Iron Bar", -- [10]
	"Mageweave Cloth", -- [11]
	"Solid Stone", -- [12]
	"Insightful Earthstorm Diamond", -- [13]
	"Mote of Fire", -- [14]
	"Mote of Earth", -- [15]
	"Elemental Blasting Powder", -- [16]
	"talasite", -- [17]
	"Star of Elune", -- [18]
	"Superior Wizard Oil;;;;;;;;;;", -- [19]
	"Superior Wizard Oil", -- [20]
	"oil", -- [21]
	"Blackened Basilisk", -- [22]
	"basilisk", -- [23]
	"exodar", -- [24]
	"[netherweave cloth]", -- [25]
	"netherweave cloth", -- [26]
	"Sleeveless T-Shirt", -- [27]
	";Glyphs/Priest;;;;;;;;;", -- [28]
	";Gems/Red;;;;;;;;;2", -- [29]
	"pure death", -- [30]
}
